...
//     // Do the handshake
//     // Setup keys
//     std::list<fp_network::Data> reordered_msg_queue;
...
//             //process p_msg
//             fp_network::Data p_msg = std::move(reordered_msg_queue.front());
//             OnDataFrame(p_msg);
...
//                 const fp_network::Data& data_msg = msg.data_msg();
...
//                 continue;
//             }
//             LOG_INFO("Sending during HS_WAITING_SHAKE_ACK");
