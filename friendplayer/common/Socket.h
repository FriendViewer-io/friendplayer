...
//     void StartSocket();
//     void Stop();
//     void MessageSend(const fp_network::Message& outgoing_msg,
...
//     void SendStreamState(fp_network::ClientState::State state);
//     void SendRequestToHost(fp_network::RequestToHost::RequestType request);

//     void SendController(const fp_network::ControllerFrame& frame);
...
//     void SendStreamState(fp_network::HostState::State state);
