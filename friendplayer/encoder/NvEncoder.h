...
public:
    ...
    */
    ...
    const NvEncInputFrame* GetPrevInputFrame();
...
private:
    ...
    uint32_t m_nExtraOutputDelay = 0; // To ensure encode and graphics can work in parallel, m_nExtraOutputDelay should be set to at least 1
